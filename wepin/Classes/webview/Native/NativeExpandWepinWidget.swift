...
struct NativeExpandWepinWidgetModel: APIResponserWithParamter {
    ...
    var result: Param_Native_Response_ExpandWepinWidget?
    
    mutating func procAfterInit() {
                
        result = Param_Native_Response_ExpandWepinWidget()
